...
# értelemben (egyelőre). Csupán annyi 
...
# ingadozik (az érme szabályos). A ténylegesen elvégzett kísérletek ezt 
# igazolják is. 
...
fejgyak <- cumsum(dobasok == 'F') / 1:ndobas
...
# Ezek valószínűsege a 16-elem? eseménytéren kombinatorikus valószínűséggel 
...
########## FELADAT 6 ##########
lambda = log(3)
round(1 - sum(dpois(0:1, lambda)), 2)

### FELADAT 2.9 ###
p = 1 / 5
n = 10
k = 4
round(1 - sum(dbinom(0:k - 1, n, p)), 4)
